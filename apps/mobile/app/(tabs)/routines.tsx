...
const makeStyles = (colors: Palette) =>
  StyleSheet.create({
    ...
    startEmptyLabel: { ...typography.button, color: "#fff" },
    ...
    outlineBtnText: { ...typography.button, color: colors.text },
    menuBackdrop: {
      flex: 1,
    ...
    menuActionText: { ...typography.button, color: colors.text },
    ...
    menuCancelText: { ...typography.button, color: colors.textMuted },
  });
