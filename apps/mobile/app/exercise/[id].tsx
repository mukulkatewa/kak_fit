...
const makeStyles = (colors: Palette) => StyleSheet.create({
  ...
  howToText: { ...typography.body, color: colors.text, flex: 1 },
  ...
  rangeText: { ...typography.bodySmall, color: colors.accent },
  metricTabs: { gap: spacing.sm, paddingHorizontal: spacing.lg, paddingVertical: spacing.md },
  metricTab: { minHeight: 44, paddingHorizontal: spacing.lg, borderRadius: radius.full, backgroundColor: colors.surfaceHover, alignItems: "center", justifyContent: "center" },
  metricTabActive: { backgroundColor: colors.accent },
  metricTabText: { ...typography.bodySmall, color: colors.text },
  ...
  prTitle: { flex: 1, ...typography.body, fontWeight: "600", color: colors.textMuted },
