...
import { TOUCH_TARGET_MIN } from "../lib/layout-constants";
...
const makeStyles = (colors: Palette, shadows: ShadowSet) =>
  StyleSheet.create({
    ...
    titleRow: { flexDirection: "row", alignItems: "center", gap: spacing.xs, flex: 1, minWidth: 0 },
    title: { ...typography.h1, color: colors.text },
    actions: { flexDirection: "row", alignItems: "center", gap: spacing.md },
    iconBtn: { minWidth: TOUCH_TARGET_MIN, minHeight: TOUCH_TARGET_MIN, alignItems: "center", justifyContent: "center" },
    ...
    bannerText: { flex: 1, color: "#fff", ...typography.body },
    ...
    cancelText: { ...typography.body, color: colors.accent, minWidth: 70, minHeight: TOUCH_TARGET_MIN, textAlignVertical: "center" },
    modalTitle: { ...typography.body, fontWeight: "600", color: colors.text },
    saveBtn: {
    ...
    saveText: { ...typography.bodySmall, fontWeight: "600", color: colors.text },
    infoStrip: {
      flexDirection: "row",
      alignItems: "center",
    ...
    infoText: { flex: 1, color: "#1a1a1a", ...typography.bodySmall },
    underlineInput: {
      ...typography.body,
      color: colors.text,
      paddingVertical: spacing.md,
    ...
    stackBack: { width: TOUCH_TARGET_MIN, flexShrink: 0, alignItems: "flex-start" },
    stackTitle: { ...typography.body, fontWeight: "600", color: colors.text, textAlign: "center", flex: 1 },
    stackRight: { minWidth: TOUCH_TARGET_MIN, flexShrink: 0, alignItems: "flex-end", justifyContent: "center" },
    ...
    programTitle: { ...typography.h3, color: colors.text },
    programMeta: { ...typography.bodySmall, color: colors.textMuted },
    trainerCard: {
      backgroundColor: colors.surface,
    ...
    trainerTitle: { ...typography.h2, color: colors.text, textAlign: "center" },
    trainerSubtitle: { ...typography.bodySmall, color: colors.textMuted, textAlign: "center" },
    trainerCta: {
      alignSelf: "stretch",
      marginTop: spacing.md,
      backgroundColor: colors.accent,
      borderRadius: radius.md,
      minHeight: TOUCH_TARGET_MIN + spacing.md,
      alignItems: "center",
      justifyContent: "center",
    },
    trainerCtaText: { ...typography.button, color: "#fff" },
    categoryTile: {
      flexBasis: "48%",
      flexGrow: 1,
      maxWidth: "48%",
    ...
    categoryIcon: { fontSize: 28 }, // decorative emoji scale
    outlineBtn: {
      backgroundColor: colors.surface,
      borderRadius: radius.lg,
      paddingVertical: 16,
